    ...
    <div class="container">
        ...
        <div class="row">
            <div class="wrap-login col-md-4 col-md-offset-4">
                <h2 style="margin-bottom:30px">Customer SignUp</h2>
                <form action="register.php" method="post">
                    ...
                    <!-- <div class="dropdown" class="form-group">
                        <button class="btn btn-primary dropdown-toggle" name="city" type="button" data-toggle="dropdown">City
            ...
            if(!empty($password)){
                if(!empty($phone_no)){
                    if(!empty($city)){
                        ...
                        $select="SELECT * FROM `crackers`.`signing_table` WHERE `email`='$email'";
                        ...
                        if(mysqli_num_rows($query_run)>0){
                           ...
                           $mysqli=("INSERT INTO `signing_table`(`id`, `user_name`, `password`, `email`, `phone_no`, `city`) VALUES (NULL,'$username','$password','$email',$phone_no,'$city')");
                           $query=mysqli_query($con,$mysqli);
                           if($query){
                               echo '<script language="javascript">alert("Registered Successfully");window.location.href = "login.php";</script>';
