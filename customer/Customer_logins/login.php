  ...
  <body >
    ...
    <!-- Responsive Navigation bar  -->
        ...
        <div class="navbar navbar-default navbar-fixed-top">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="register.php"><i class="glyphicon glyphicon-log-out"></i> SignUp</a></li>
            </ul></div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="row">
            <div class="wrap-login col-md-4 col-md-offset-4" style="background-color:aqua">
                <h2 style="margin-bottom:30px">Customer Login</h2>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4 text-center" style="margin-top:30px;">
                <a href="register.php"><h4>Create New Account?</h4></a>
            </div>
        </div>
...
if(isset($_POST['login'])){
    ...
    if(!empty($email)&&!empty($pass)){
        $query="SELECT * FROM `crackers`.`signing_table` WHERE `email`='$email' AND `password`='$pass'";
