...
--
-- Host: localhost
-- Generation Time: Nov 07, 2017 at 03:02 PM
...
-- Database: `Kinetic_DB`
--
CREATE DATABASE IF NOT EXISTS `Kinetic_DB` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `Kinetic_DB`;
...
DROP TABLE IF EXISTS `Side_Nav_Bar_Headings`;
